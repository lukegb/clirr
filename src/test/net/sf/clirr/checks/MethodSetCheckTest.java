...
public class MethodSetCheckTest extends AbstractCheckTestCase
{
    public void testMethodCheck() throws Exception
    {
        ApiDifference[] expected = new ApiDifference[] {
            ...
            new ApiDifference("Method 'public void removedMethod(java.lang.String)' has been removed",
                    Severity.ERROR, "testlib.MethodsChange", "public void removedMethod(java.lang.String)", null),
            new ApiDifference("Accessability of method 'public int getPriv2()' has been decreased from public to private",
                    Severity.ERROR, "testlib.MethodsChange", "public int getPriv2()", null),
            new ApiDifference("Method 'protected MethodsChange(int, boolean)' has been added",
                    Severity.INFO, "testlib.MethodsChange", "protected MethodsChange(int, boolean)", null),
            new ApiDifference("Method 'public java.lang.Long getPrivSquare()' has been added",
                    Severity.INFO, "testlib.MethodsChange", "public java.lang.Long getPrivSquare()", null),

            new ApiDifference("Method 'public void moveToSuper()' has been added",
                    Severity.INFO, "testlib.ComplexMethodMoveBase", "public void moveToSuper()", null),
            new ApiDifference("Method 'public void moveToSuper()' is now implemented in superclass testlib.ComplexMethodMoveBase",
                    Severity.INFO, "testlib.ComplexMethodMoveSub", "public void moveToSuper()", null),

            new ApiDifference("Abstract method 'public void method()' is now specified by implemented interface testlib.BaseInterface",
                    Severity.INFO, "testlib.AbstractImpl", "public void method()", null),

            // Constructor changes
            new ApiDifference("Parameter 1 of 'protected MethodsChange(int)' has changed its type to java.lang.Integer",
            ...
            new ApiDifference("In method 'public void printPriv()' the number of arguments has changed",
                    Severity.ERROR, "testlib.MethodsChange", "public void printPriv()", null),
            new ApiDifference("Parameter 1 of 'public void strengthenParamType(java.lang.Object)' has changed its type to java.lang.String",
                    Severity.ERROR, "testlib.MethodsChange", "public void strengthenParamType(java.lang.Object)", null),
            new ApiDifference("Parameter 1 of 'public void weakenParamType(java.lang.String)' has changed its type to java.lang.Object",
                    Severity.ERROR, "testlib.MethodsChange", "public void weakenParamType(java.lang.String)", null),
            new ApiDifference("Parameter 1 of 'public void changeParamType(java.lang.String)' has changed its type to java.lang.Integer",
                    Severity.ERROR, "testlib.MethodsChange", "public void changeParamType(java.lang.String)", null),

            // deprecation changes
            new ApiDifference("Method 'public void becomesDeprecated()' has been deprecated",
                    Severity.INFO, "testlib.MethodsChange", "public void becomesDeprecated()", null),
            new ApiDifference("Method 'public void becomesUndeprecated()' is no longer deprecated",
